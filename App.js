...
import Calc from './page/calc.js'; //calc
...
import Shop from './page/shop.js'; // 오렌지마켓 리스트
import Shop0 from './page/shop0.js'; // 오렌지마켓 상세
import ShopMy from './page/shopmy.js'; // 오렌지마켓 마이
import ShopMade from './page/shopmade.js'; // 오렌지마켓 생성하기
import Modify from './page/modify.js'; // 오렌지마켓 수정하기
// 
// 중고샵 들어가기전 로그인, 회원가입
import Login from './form_login.js';
import Join from './form_join.js';
// import Join from './form_join.js'; 
//
...
function App() {
  // let looks2 = useRef(null)
  // let look2 = looks2.current.offsetHeight
    ...
    <div >
      <Router>
        ...
        <Routes>
            ...
            <>
              <div className="life_wrap ">
                ...
                <div className="lief_area ">
                    ...
                    <div className="">
                      <div><h3>History</h3>
                        <div className="intro_wrap">
                          ...
                          <br/>
                          <span className="clearfix">2. 작업중인 : <b>Project</b><a href="http://rhkstnek.dothome.co.kr/ing" target="_blank">이동</a></span>
                          <hr />
                          ...
                          <div>
                            ...
                            <ul className="intro_list clearfix">
                              ...
                              <li>여주세종문화관광재단<a href="https://www.yjcf.or.kr/yjcf" target="_blank" title="이동">이동</a></li>
                              <li>양평공사<a href="https://www.yp04.or.kr/main" target="_blank" title="이동">이동</a></li>
                              <li>오산도시공사<a href="https://www.osuc.or.kr/main" target="_blank" title="이동">이동</a></li>
                              <li>한국공예·디자인문화진흥원<a href="https://www.kcdf.or.kr/main" target="_blank" title="이동">이동</a></li>
                              <li>한국과학창의재단<a href="https://www.kofac.re.kr/main" target="_blank" title="이동">이동</a></li>
                            </ul>
                          </div>
                        </div>
                      </div>
                      <div>
                        ...
                        <ul>
                          ...
                          <li>
                            ...
                            CSS</li>
                            <li><img src={process.env.PUBLIC_URL + `/img/scss.png`} alt='Scss' />
                            Scss</li>
                          <li>
                  ...
                  <div
                    // ref={looks2}
                    className={scr > 1150 ? `wrap3 scrolled` : `wrap3`}>
                    {/* {console.log(look2)} */}
                    <h3>1. Project ( tab )</h3>
                    <LeftTabsExample tab={tab} setTab={setTab} />
                    {/* 27700 */}
                    <div className={scr > 1850 ? `wrap3_2 scrolled` : `wrap3_2`}>
                      <h3>2. Project ( url )</h3>
          ...
          <Route path="/shopmade" element={<ShopMade product={product} setProduct={setProduct}
            idNum={idNum} setIdNum={setIdNum} id={id} setId={setId}
          />} />
          <Route path="/modify/:uid" element={<Modify product={product}
