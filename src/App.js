...
import Used from './page/used.js'; // 오이마켓 리스트
import Used0 from './page/used0.js'; // 오이마켓 상세
import UsedMy from './page/usedmy.js'; // 오이마켓 마이
import Made from './page/made.js'; // 오이마켓 생성하기
import Modify from './page/modify.js'; // 오이마켓 수정하기
// 
...
function App() {
  const [product, setProduct] = useState([
    ...
    { id: 9, thumb: 'https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcTtb2I-kkcuV_T3FRoW3kWsOzoWExgcYxMgkg&s', title: 'S23울트라 급매', price: 400000, doc: '3사 통신사 기변가능', address: '대구 달서구' },
  ])
    ...
    <div >
      <Router>
        ...
        <Routes>
          ...
          <Route path="/used" element={<Used product={product} id={id} setId={setId}/>} />
          <Route path="/used/used0/:uid" element={<Used0 product={product} />} />
          <Route path="/usedmy" element={<UsedMy product={product} id={id} setId={setId} setProduct={setProduct}/>} />
          <Route path="/made" element={<Made product={product} setProduct={setProduct}
